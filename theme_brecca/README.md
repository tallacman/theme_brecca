...
- remove account menu
- resolved issue with animate preventing the moving of blocks in the main area fixed most coding practices to current standards removed useless page templates
- raised version to 8.2 minimum

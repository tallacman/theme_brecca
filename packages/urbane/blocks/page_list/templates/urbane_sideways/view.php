...
if (is_object($c) && $c->isEditMode() && $controller->isBlockEmpty()) {
    ...
    <div class="ccm-block-page-list-wrapper urbane-sideways">
            ...
            foreach ($pages as $page) {
                ...
                <div class="<?php echo $entryClasses ?>">
                    ...
                    <?php if (is_object($thumbnail)) {
                        ?>
                        <div class="col-12 col-md-6 col-lg-5 urbane-thumbnail">
                            <?php
                    ...
                    <?php if ($includeEntryText) {
                        ?>
                        <div class="ccm-block-page-list-page-entry-text col-12 col-md-6 col-lg-7">

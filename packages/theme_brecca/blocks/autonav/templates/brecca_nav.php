...
if (count($navItems) > 0) {
    echo '<ul id="menu" class="nav container justify-center brecca-nav">'; //opens the top-level menu

    foreach ($navItems as $ni) {

        echo '<li class="col-4 col-xs-3 col-sm-2 pad-right pad-left' . $ni->classes . '">'; //opens a nav item
